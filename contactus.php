...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.iccsdes@gmail.com';
    $mail->Password   = 'fyyg uooh jwru zlyy'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.iccsdes@gmail.com', 'ICCSDES Enquiry');
    $mail->addAddress('info.iccsdes@gmail.com', 'ICCSDES Enquiry');
    ...
    $replyMail->Username   = 'info.iccsdes@gmail.com';
    $replyMail->Password   = 'fyyg uooh jwru zlyy';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.iccsdes@gmail.com', 'ICCSDES Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICCSDES 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICCSDES 2025 Team</p>
        </div>
    ';
